  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
      ...
      HAL_Delay(500);                         // Wait 500 ms
	    ...
	    uint16_t angle = AS5600_ReadAngle(AS5600_RAW_ANGLE_REG);
	    printf("Status: 0x%02X, Raw Angle: %u\r\n", status, angle);
      ...
      uint16_t angle = AS5600_ReadAngleStatus();
...
//      uint8_t msg[] = "Hello from ESC board\r\n";
